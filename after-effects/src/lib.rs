...
// This is an FFI binding crate. The lints below fire pervasively on the 1:1
// mappings of Adobe's C SDK and on the suite/param wrapper macros; "fixing"
// them would distort the SDK mapping rather than improve anything, so they
// are allowed crate-wide with intent:
#![allow(clippy::too_many_arguments)] // wrappers mirror Adobe's C function signatures
#![allow(clippy::missing_transmute_annotations)] // transmutes punning layout-identical SDK types
#![allow(clippy::useless_transmute)] // punning between layout-identical SDK <-> safe types
#![allow(clippy::from_raw_with_void_ptr)] // boxed trait objects round-tripped through Adobe void*
#![allow(clippy::type_complexity)] // FFI callback / closure signatures
#![allow(clippy::question_mark)] // generated by define_param_wrapper
#![allow(clippy::drop_non_drop)] // generated by define_iterate
