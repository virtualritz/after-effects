...
impl CanvasSuite {
    ...
    pub fn render_texture(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle, render_hints: RenderHints, suggested_scale: Option<FloatPoint>, suggested_src_rect: Option<FloatRect>, src_matrix: Option<Matrix3>) -> Result<WorldHandle, Error> {
        Ok(WorldHandle::from_raw(
            call_suite_fn_single!(self,
    ...
    pub fn dispose_texture(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle, world_handle: WorldHandle) -> Result<(), Error> {
    ...
    pub fn report_artisan_progress(&self, render_ctx: &RenderContextHandle, count: i32, total: i32) -> Result<(), Error> {
    ...
    pub fn set_render_downsample_factor(&self, render_ctx: &RenderContextHandle, mut dsf: ae_sys::AEGP_DownsampleFactor) -> Result<(), Error> {
    ...
    pub fn is_blank_canvas(&self, render_ctx: &RenderContextHandle) -> Result<bool, Error> {
    ...
    pub fn is_render_layer_active(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle, comp_time: Time) -> Result<bool, Error> {
    ...
    pub fn set_artisan_layer_progress(&self, render_ctx: &RenderContextHandle, count: i32, num_layers: i32) -> Result<(), Error> {
    ...
    pub fn render_layer_plus(&self, render_ctx: &RenderContextHandle, layer_handle: LayerHandle, layer_ctx: RenderLayerContextHandle, render_hints: RenderHints) -> Result<WorldHandle, Error> {
        Ok(WorldHandle::from_raw(
    ...
    pub fn render_texture_with_receipt(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle, render_hints: RenderHints, num_effects: RenderNumEffects, suggested_scale: Option<FloatPoint>, suggested_src_rect: Option<FloatRect>, src_matrix: Option<Matrix3>) -> Result<(RenderReceiptHandle, WorldHandle), Error> {
    ...
    pub fn render_layer_plus_with_receipt(&self, render_ctx: &RenderContextHandle, layer_handle: LayerHandle, layer_ctx: RenderLayerContextHandle, render_hints: RenderHints) -> Result<(RenderReceiptHandle, WorldHandle), Error> {
        let (receipt, world) = call_suite_fn_double!(self,
    ...
    pub fn check_render_receipt(&self, current_render_ctx: RenderContextHandle, current_layer_ctx: RenderLayerContextHandle, old_render_receipt_handle: RenderReceiptHandle, check_geometrics: bool, num_effects: RenderNumEffects) -> Result<RenderReceiptStatus, Error> {
    ...
    pub fn generate_render_receipt(&self, current_render_ctx: RenderContextHandle, current_layer_ctx: RenderLayerContextHandle, num_effects: RenderNumEffects) -> Result<RenderReceiptHandle, Error> {
    ...
    pub fn set_nth_bin(&self, render_ctx: &RenderContextHandle, n: i32) -> Result<(), Error> {
    ...
    ///
    /// This function is valid for interactive artisans only.
    pub fn artisan_must_render_as_layer(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle) -> Result<bool, Error> {
    ...
    ///
    /// This function is valid for interactive artisans only.
    pub fn map_comp_to_layer_time(&self, render_ctx: &RenderContextHandle, layer_ctx: RenderLayerContextHandle, comp_time: Time) -> Result<Time, Error> {
