use crate::*;
use crate::aegp::*;
use ae_sys::{ A_long, A_short, A_Time, AEGP_StreamValue2, AEGP_KeyframeEase };
...
impl KeyframeSuite {
    ...
    pub fn insert_keyframe(&self, stream: &StreamReferenceHandle, time_mode: TimeMode, time: Time) -> Result<i32, Error> {
    ...
    pub fn delete_keyframe(&self, stream: &StreamReferenceHandle, key_index: i32) -> Result<(), Error> {
    ...
    pub fn set_keyframe_value(&self, stream: &StreamReferenceHandle, key_index: i32, value: StreamValue) -> Result<(), Error> {
    ...
    pub fn set_keyframe_spatial_tangents(&self, stream: &StreamReferenceHandle, key_index: i32, in_tan: StreamValue, out_tan: StreamValue) -> Result<(), Error> {
    ...
    pub fn set_keyframe_temporal_ease(&self, stream: &StreamReferenceHandle, key_index: i32, dimension: i32, in_ease: &AEGP_KeyframeEase, out_ease: &AEGP_KeyframeEase) -> Result<(), Error> {
    ...
    pub fn set_keyframe_flag(&self, stream: &StreamReferenceHandle, key_index: i32, flag: KeyframeFlags, value: bool) -> Result<(), Error> {
    ...
    pub fn set_keyframe_interpolation(&self, stream: &StreamReferenceHandle, key_index: i32, in_interp: KeyframeInterpolation, out_interp: KeyframeInterpolation) -> Result<(), Error> {
    ...
    pub fn start_add_keyframes(&self, stream: &StreamReferenceHandle) -> Result<AddKeyframesInfoHandle, Error> {
    ...
    pub fn set_keyframe_label_color_index(&self, stream: &StreamReferenceHandle, key_index: i32, key_label: i32) -> Result<(), Error> {
...
impl AddKeyframesInfoHandle {
    ...
    pub fn set_add_keyframe(&mut self, key_index: i32, stream: &StreamReferenceHandle, value: StreamValue) -> Result<(), Error> {
        let sys_stream_value2 = AEGP_StreamValue2 {
            streamH: stream.as_ptr(),
            val: value.to_sys()
        };
