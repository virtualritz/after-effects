...
impl FootageSuite {
    ...
    pub fn set_footage_interpretation(&self, item_handle: ItemHandle, proxy: bool, interp: &ae_sys::AEGP_FootageInterp) -> Result<(), Error> {
    ...
    pub fn set_solid_footage_color(&self, item_handle: ItemHandle, proxy: bool, color: &ae_sys::AEGP_ColorVal) -> Result<(), Error> {
    ...
    pub fn set_solid_footage_dimensions(&self, item_handle: ItemHandle, proxy: bool, width: i32, height: i32) -> Result<(), Error> {
