...
impl ItemSuite {
    ...
    pub fn get_first_proj_item(&self, project_handle: ProjectHandle) -> Result<ItemHandle, Error> {
    ...
    pub fn get_next_proj_item(&self, project_handle: ProjectHandle, item_handle: ItemHandle) -> Result<Option<ItemHandle>, Error> {
    ...
    pub fn get_active_item(&self) -> Result<Option<ItemHandle>, Error> {
    ...
    pub fn get_item_type(&self, item_handle: ItemHandle) -> Result<ItemType, Error> {
    ...
    pub fn get_type_name(&self, item_type: ItemType) -> Result<String, Error> {
    ...
    /// Get item name.
    pub fn get_item_name(&self, plugin_id: PluginID, item_handle: ItemHandle) -> Result<String, Error> {
    ...
    pub fn get_item_flags(&self, item_handle: ItemHandle) -> Result<ItemFlags, Error> {
    ...
    pub fn get_item_parent_folder(&self, item_handle: ItemHandle) -> Result<Option<ItemHandle>, Error> {
    ...
    pub fn get_item_duration(&self, item_handle: ItemHandle) -> Result<Time, Error> {
    ...
    pub fn get_item_current_time(&self, item_handle: ItemHandle) -> Result<Time, Error> {
    ...
    pub fn get_item_pixel_aspect_ratio(&self, item_handle: ItemHandle) -> Result<Ratio, Error> {
    ...
    pub fn get_item_comment(&self, item_handle: ItemHandle) -> Result<String, Error> {
    ...
    pub fn get_item_label(&self, item_handle: ItemHandle) -> Result<LabelId, Error> {
    ...
    pub fn get_item_mru_view(&self, item_handle: ItemHandle) -> Result<ae_sys::AEGP_ItemViewP, Error> {
